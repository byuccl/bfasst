...
These were pulled from VTR commit: cf830b5d21a9387d32d8b48b08c054691f15ee25
Modifications have been made to get the designs working with Vivado. The directory structure has been reorganized to integrate the designs with BFASST. Below is the README that VTR included with the KOIOS designs. The license mentioned applies to the hdl files in the koios directory.
...
## License
Koios benchmarks are distributed under the [same license as VTR](./KOIOS_LICENSE.md). 
