...
// Date        : Tue Mar 16 16:16:40 2021
// Host        : DESKTOP-7BJQ087 running 64-bit major release  (build 9200)
// Command     : write_verilog -force riscv_io_forwarding_i.v
...
module SevenSegmentControl4
  ...
  CARRY4 \count_val_reg[0]_i_1
       (.CI(\<const0> ),
        ...
        .S({debounce_counter_reg[3:1],\count_val[0]_i_2_n_0 }));
  FDRE #(
    .INIT(1'b0))
    \count_val_reg[10]
       (.C(clk_proc),
  ...
  CARRY4 \count_val_reg[12]_i_1
       (.CI(\count_val_reg[8]_i_1_n_0 ),
        ...
        .S({anode_select[0],debounce_counter_reg[14:12]}));
  FDRE #(
    .INIT(1'b0))
    \count_val_reg[13]
       (.C(clk_proc),
  ...
  LUT6 #(
    ...
    \sw_deb[15]_i_1
       (.I0(\sw_deb[15]_i_2_n_0 ),
        .I1(\sw_deb[15]_i_3_n_0 ),
        .I2(\sw_deb[15]_i_4_n_0 ),
        .I3(debounce_counter_reg[11]),
        .I4(debounce_counter_reg[7]),
        .I5(debounce_counter_reg[6]),
        .O(\count_val_reg[11]_0 ));
  LUT6 #(
    .INIT(64'h0000000000000001))
    \sw_deb[15]_i_2
       (.I0(debounce_counter_reg[5]),
        .I1(debounce_counter_reg[1]),
        .I2(debounce_counter_reg[0]),
        .I3(debounce_counter_reg[4]),
        .I4(anode_select[0]),
        .I5(anode_select[1]),
        .O(\sw_deb[15]_i_2_n_0 ));
  LUT4 #(
    .INIT(16'hFFFE))
    \sw_deb[15]_i_3
       (.I0(debounce_counter_reg[14]),
        .I1(debounce_counter_reg[9]),
        .I2(debounce_counter_reg[13]),
        .I3(debounce_counter_reg[2]),
        .O(\sw_deb[15]_i_3_n_0 ));
  LUT4 #(
    .INIT(16'hFFFE))
    \sw_deb[15]_i_4
       (.I0(debounce_counter_reg[12]),
        .I1(debounce_counter_reg[3]),
        .I2(debounce_counter_reg[10]),
        .I3(debounce_counter_reg[8]),
        .O(\sw_deb[15]_i_4_n_0 ));
endmodule

module charColorMem3
   (char_ram_reg_0_i_6_0,
    \bbstub_dAddress[27] ,
    \bbstub_dAddress[14] ,
    \bbstub_dAddress[20] ,
    vgaBlue,
  ...
  output char_ram_reg_0_i_6_0;
  output \bbstub_dAddress[27] ;
  output \bbstub_dAddress[14] ;
  output \bbstub_dAddress[20] ;
  output [3:0]vgaBlue;
  ...
  RAMB36E1 #(
    ...
    char_ram_reg_0
       (.ADDRARDADDR({\<const1> ,out[11:0],\<const0> ,\<const0> ,\<const0> }),
        .ADDRBWRADDR({\<const1> ,vga_addr,\<const0> ,\<const0> ,\<const0> }),
        .CASCADEINA(\<const1> ),
        .CASCADEINB(\<const1> ),
        .CLKARDCLK(clk_proc),
        .CLKBWRCLK(CLK),
  ...
  LUT6 #(
    ...
    char_ram_reg_0_i_2
       (.I0(\bbstub_dAddress[14] ),
        .I1(out[29]),
        .I2(out[13]),
        .I3(out[28]),
        .I4(char_ram_reg_0_i_6_0),
        .I5(MemWrite),
        .O(char_value_write));
  LUT4 #(
    .INIT(16'hFFFE))
    char_ram_reg_0_i_3
       (.I0(\bbstub_dAddress[20] ),
        .I1(out[14]),
        .I2(out[15]),
        .I3(out[12]),
        .O(\bbstub_dAddress[14] ));
  LUT5 #(
    .INIT(32'hFFFFFFFE))
    char_ram_reg_0_i_4
       (.I0(out[27]),
  ...
  RAMB36E1 #(
    ...
    char_ram_reg_1
       (.ADDRARDADDR({\<const1> ,out[11:0],\<const0> ,\<const0> ,\<const0> }),
        ...
        .DOBDO(vga_read_value[16:9]),
        .DOPADOP(char_ram_reg_1_n_71),
        .DOPBDOP(vga_read_value[17]),
        .ENARDEN(\<const1> ),
        .ENBWREN(\<const1> ),
        .REGCEAREGCE(\<const0> ),
        .REGCEB(\<const0> ),
  ...
  RAMB36E1 #(
    ...
    char_ram_reg_2
       (.ADDRARDADDR({\<const1> ,out[11:0],\<const0> ,\<const0> ,\<const0> }),
        ...
        .DOBDO(vga_read_value[25:18]),
        .DOPADOP(char_ram_reg_2_n_71),
        .DOPBDOP(vga_read_value[26]),
        .ENARDEN(\<const1> ),
        .ENBWREN(\<const1> ),
        .REGCEAREGCE(\<const0> ),
        .REGCEB(\<const0> ),
  ...
  LUT6 #(
    .INIT(64'h00000000FEAE02A2))
    \vgaBlue[2]_INST_0
       (.I0(vga_read_value[22]),
        .I1(vgaBlue_0_sn_1),
        .I2(Q),
        .I3(\vgaBlue[0]_0 ),
        .I4(vga_read_value[10]),
        .I5(blank_d2),
        .O(vgaBlue[2]));
  LUT6 #(
    .INIT(64'h00000000FEAE02A2))
    \vgaBlue[3]_INST_0
       (.I0(vga_read_value[23]),
        .I1(vgaBlue_0_sn_1),
        .I2(Q),
        .I3(\vgaBlue[0]_0 ),
        .I4(vga_read_value[11]),
        .I5(blank_d2),
        .O(vgaBlue[3]));
  LUT6 #(
    .INIT(64'h00000000FEAE02A2))
    \vgaGreen[0]_INST_0
       (.I0(vga_read_value[24]),
        .I1(vgaBlue_0_sn_1),
        .I2(Q),
        .I3(\vgaBlue[0]_0 ),
        .I4(vga_read_value[12]),
        .I5(blank_d2),
        .O(vgaGreen[0]));
  LUT6 #(
    .INIT(64'h00000000FEAE02A2))
    \vgaGreen[1]_INST_0
       (.I0(vga_read_value[25]),
        .I1(vgaBlue_0_sn_1),
        .I2(Q),
        .I3(\vgaBlue[0]_0 ),
        .I4(vga_read_value[13]),
        .I5(blank_d2),
        .O(vgaGreen[1]));
  LUT6 #(
    .INIT(64'h00000000FEAE02A2))
    \vgaGreen[2]_INST_0
       (.I0(vga_read_value[26]),
        .I1(vgaBlue_0_sn_1),
        .I2(Q),
        .I3(\vgaBlue[0]_0 ),
        .I4(vga_read_value[14]),
        .I5(blank_d2),
        .O(vgaGreen[2]));
  LUT6 #(
    .INIT(64'h00000000FEAE02A2))
    \vgaGreen[3]_INST_0
       (.I0(vga_read_value[27]),
        .I1(vgaBlue_0_sn_1),
        .I2(Q),
        .I3(\vgaBlue[0]_0 ),
        .I4(vga_read_value[15]),
        .I5(blank_d2),
        .O(vgaGreen[3]));
  LUT6 #(
    .INIT(64'h00000000FEAE02A2))
    \vgaRed[0]_INST_0
       (.I0(vga_read_value[28]),
        .I1(vgaBlue_0_sn_1),
        .I2(Q),
        .I3(\vgaBlue[0]_0 ),
        .I4(vga_read_value[16]),
        .I5(blank_d2),
        .O(vgaRed[0]));
  LUT6 #(
    .INIT(64'h00000000FEAE02A2))
    \vgaRed[1]_INST_0
       (.I0(vga_read_value[29]),
        .I1(vgaBlue_0_sn_1),
        .I2(Q),
        .I3(\vgaBlue[0]_0 ),
        .I4(vga_read_value[17]),
        .I5(blank_d2),
        .O(vgaRed[1]));
  LUT6 #(
    .INIT(64'h00000000FEAE02A2))
    \vgaRed[2]_INST_0
       (.I0(vga_read_value[30]),
        .I1(vgaBlue_0_sn_1),
        .I2(Q),
        .I3(\vgaBlue[0]_0 ),
        .I4(vga_read_value[18]),
        .I5(blank_d2),
        .O(vgaRed[2]));
  LUT6 #(
    .INIT(64'h00000000FEAE02A2))
    \vgaRed[3]_INST_0
       (.I0(vga_read_value[31]),
        .I1(vgaBlue_0_sn_1),
        .I2(Q),
        .I3(\vgaBlue[0]_0 ),
        .I4(vga_read_value[19]),
        .I5(blank_d2),
        .O(vgaRed[3]));
endmodule
...
module charGen3
  ...
  wire [3:0]vgaGreen;
  wire [3:0]vgaRed;
  wire [6:0]vga_read_value;

  GND GND
       (.G(\<const0> ));
  VCC VCC
       (.P(\<const1> ));
  charColorMem3 charmem
       (.CLK(CLK),
        .MemWrite(MemWrite),
        .Q(ddr2[2]),
        .\bbstub_dAddress[14] (\bbstub_dAddress[14] ),
        .\bbstub_dAddress[20] (\bbstub_dAddress[20] ),
        .\bbstub_dAddress[27] (\bbstub_dAddress[27] ),
        .blank_d2(blank_d2),
        .char_ram_reg_0_0(vga_read_value),
        .char_ram_reg_0_i_6_0(char_ram_reg_0_i_6),
        ...
        .vgaGreen(vgaGreen),
        .vgaRed(vgaRed),
        .vga_addr({Q[8:4],char_ram_reg_0[9:3]}));
  FDRE \ddr2_reg[0]
       (.C(CLK),
        .CE(\<const1> ),
        .D(ddr[0]),
  ...
  FDRE \ddr_reg[2]
       (.C(CLK),
        ...
        .R(\<const0> ));
  font_rom fontrom
       (.ADDRARDADDR({vga_read_value,Q[3:0]}),
        .CLK(CLK),
        .Q(ddr2[1:0]),
...
module rx
  ...
  wire \io_memory_read[1]_i_7_n_0 ;
  ...
  LUT5 #(
    .INIT(32'h6FFF6F00))
    error_int_i_1
       (.I0(error_int_i_2_n_0),
        .I1(error_int_i_3_n_0),
  ...
  LUT6 #(
    ...
    \io_memory_read[1]_i_1
       (.I0(Q[0]),
        ...
        .I3(out[3]),
        .I4(out[2]),
        .I5(\io_memory_read[1]_i_3_n_0 ),
        .O(D[1]));
  LUT6 #(
    .INIT(64'hFBBB0888FBBBFBBB))
    \io_memory_read[1]_i_3
       (.I0(data5[1]),
        ...
        .I5(\io_memory_read[1]_i_5_n_0 ),
        .O(\io_memory_read[1]_i_3_n_0 ));
  LUT6 #(
    .INIT(64'h55775F7755775577))
    \io_memory_read[1]_i_5
       (.I0(out[2]),
        .I1(rx_data[1]),
        .I2(\io_memory_read[1]_i_6_n_0 ),
        .I3(out[0]),
        .I4(\FSM_onehot_state_reg_n_0_[0] ),
        .I5(\io_memory_read[1]_i_7_n_0 ),
  ...
  LUT3 #(
    .INIT(8'h01))
    \io_memory_read[1]_i_7
       (.I0(\FSM_onehot_state_reg_n_0_[3] ),
        .I1(\FSM_onehot_state_reg_n_0_[2] ),
        .I2(\FSM_onehot_state_reg_n_0_[5] ),
        .O(\io_memory_read[1]_i_7_n_0 ));
  LUT4 #(
    .INIT(16'h8F80))
...
module tx
  ...
  wire \shift_register[0]_i_5_n_0 ;
  ...
  LUT6 #(
    .INIT(64'h00FB00FBFF040000))
    \FSM_sequential_state[1]_i_2
       (.I0(char_ram_reg_0_i_6),
        .I1(MemWrite),
  ...
  LUT4 #(
    ...
    \FSM_sequential_state[1]_i_3
       (.I0(io_space_wb_i_2_0[1]),
        .I1(io_space_wb_i_2_0[2]),
        .I2(io_space_wb_i_2_0[3]),
        .I3(io_space_wb_i_2_0[0]),
  ...
  LUT6 #(
    ...
    \FSM_sequential_state[2]_i_3
       (.I0(io_space_wb_i_2_0[0]),
        .I1(io_space_wb_i_2_0[3]),
        .I2(io_space_wb_i_2_0[2]),
        .I3(io_space_wb_i_2_0[1]),
        .I4(MemWrite),
        .I5(char_ram_reg_0_i_6),
  ...
  LUT6 #(
    ...
    io_space_wb_i_2
       (.I0(rx_new_data_reg),
        .I1(io_space_wb_i_3_n_0),
        .I2(io_space_wb_i_4_n_0),
        .I3(io_space_wb_i_5_n_0),
        .I4(io_space_wb_i_6_n_0),
        .I5(rx_new_data_reg_0),
        .O(char_ram_reg_0_i_6));
  LUT4 #(
    .INIT(16'h7FFF))
    io_space_wb_i_3
       (.I0(io_space_wb_i_2_0[5]),
        .I1(io_space_wb_i_2_0[4]),
        .I2(io_space_wb_i_2_0[7]),
        .I3(io_space_wb_i_2_0[8]),
        .O(io_space_wb_i_3_n_0));
  LUT4 #(
    .INIT(16'hEFFF))
    io_space_wb_i_4
       (.I0(io_space_wb_i_2_0[13]),
        .I1(io_space_wb_i_2_0[12]),
        .I2(io_space_wb_i_2_0[6]),
        .I3(io_space_wb_i_2_0[10]),
        .O(io_space_wb_i_4_n_0));
  LUT4 #(
    .INIT(16'hFFFD))
    io_space_wb_i_5
       (.I0(io_space_wb_i_2_0[9]),
        .I1(io_space_wb_i_2_0[18]),
        .I2(io_space_wb_i_2_0[11]),
        .I3(io_space_wb_i_2_0[19]),
        .O(io_space_wb_i_5_n_0));
  LUT4 #(
    .INIT(16'hFFFE))
    io_space_wb_i_6
       (.I0(io_space_wb_i_2_0[15]),
        .I1(io_space_wb_i_2_0[14]),
        .I2(io_space_wb_i_2_0[16]),
        .I3(io_space_wb_i_2_0[17]),
        .O(io_space_wb_i_6_n_0));
  LUT4 #(
    .INIT(16'hFF08))
  ...
  LUT6 #(
    ...
    \shift_register[0]_i_3
       (.I0(\shift_register[0]_i_4_n_0 ),
        .I1(char_ram_reg_0_i_6),
        .I2(MemWrite),
        .I3(io_space_wb_i_2_0[1]),
        .I4(io_space_wb_i_2_0[2]),
        .I5(\shift_register[0]_i_5_n_0 ),
  ...
  LUT2 #(
    .INIT(4'hE))
    \shift_register[0]_i_5
       (.I0(io_space_wb_i_2_0[0]),
        .I1(io_space_wb_i_2_0[3]),
        .O(\shift_register[0]_i_5_n_0 ));
...
module vga_ctl3
  ...
  charGen3 charGen
       (.CLK(CLK),
        ...
        .char_ram_reg_0_i_6(char_ram_reg_0_i_6),
        .char_ram_reg_3(Q),
        .clk_proc(clk_proc),
        .data_memory_read_wb(data_memory_read_wb),
        .data_space_wb(data_space_wb),
