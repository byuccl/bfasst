...
from bfasst.paths import SYNPLIFY_PRJ_TEMPLATE
...
class Ic2SynplifySynth(SynthTool):
    ...
    def create_build_snippets(self):
        ...
        self._append_build_snippets_default(
            __file__,
            {
                ...
                "input_verilog_file": (
                    self.verilog[0] if not self.use_hdl_sources else ""
    ...
    def _init_outputs(self):
        ...
        self.outputs["auto_constraints_sdc"] = (
            impl_path / f"AutoConstraint_{self.design_props.top}.sdc"
        )
        self.outputs["areasrr"] = impl_path / f"rpt_{self.design_props.top}.areasrr"
        self.outputs["areasrr_htm"] = impl_path / f"rpt_{self.design_props.top}_areasrr.htm"
        self.outputs["run_options"] = impl_path / "run_options.txt"
        self.outputs["scratch_project"] = impl_path / "scratchproject.prs"
        ...
        self.outputs["synth_synp_fdc"] = impl_path / "synth_synplify.fdc"
