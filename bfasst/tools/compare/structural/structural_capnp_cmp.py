...
class StructuralCapnpCmp(Tool):
    ...
    def __init__(
        ...
        *,
        ...
        self.rule_snippet_path = (
            COMPARE_TOOLS / "structural" / "structural_capnp_rules.ninja.mustache"
        )
    ...
    def __append_build_snippets(self):
        build_dict = {
            "utils_path": str(BFASST_UTILS),
            "phys_capnp_output": self.build_path,
            "transform_library": NINJA_TRANSFORM_TOOLS,
        ...
        with open(COMPARE_TOOLS / "structural" / "structural_capnp_build.ninja.mustache") as f:
    ...
    def add_ninja_deps(self, deps):
        ...
        deps.append(BFASST_UTILS / "compare" / "structural_capnp.py")
        deps.append(BFASST_UTILS / "capnp_cells.py")
