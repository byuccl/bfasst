...
from bfasst.legacy.tools.netlist_mapping.structural.automated_block_mapping import (
    automatically_map_blocks,
)
from bfasst.legacy.tools.netlist_mapping.structural.netlist import get_netlist
