...
from bfasst.tools.impl.ic2_impl_tool import Ic2Impl
from bfasst.tools.rev_bit.icestorm import IcestormRevBit
from bfasst.tools.synth.ic2_lse_synth_tool import Ic2LseSynth
...
class Ic2LseConformal(Flow):
    ...
    def create_build_snippets(self):
        ...
        self.icestorm_reverse_bit_tool.create_build_snippets(
            str(self.ic2_impl_tool.outputs["bitstream"])
        )
        self.conformal_tool.create_build_snippets(
            impl_netlist=str(self.ic2_impl_tool.outputs["impl_verilog"]),
            rev_netlist=str(self.icestorm_reverse_bit_tool.outputs["reversed_bitstream"]),
