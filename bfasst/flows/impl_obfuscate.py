...
class ImplObfuscate(Flow):
    ...
    def __init__(self, design):
        ...
        if self.impl_orig.impl_build["clocks"] is not "":
            print("Clocks found in design - running clock crank for ", str(design.top_file_path))
            ...
            print("No clocks found in design - running normal implementation for ", str(design.top_file_path))
