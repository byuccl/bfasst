...
from bfasst.analysis.sequential_depth import SequentialDepthAnalysis
...
class XilinxAndReversed(Flow):
    ...
    def create(self):
        ...
        logic_depth_analysis = SequentialDepthAnalysis(
            self.design.build_dir, self.design, self.flow_args
        )
        curr_job = Job(
