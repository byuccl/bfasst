...
from com.xilinx.rapidwright.edif import EDIFCellInst, EDIFHierPortInst, EDIFPortInst
...
def flip_const_port_signal(
    ...
    if old_net.isGND():
        ...
        raise RapidwrightException("Unsupported nonconstant net for inversion")
