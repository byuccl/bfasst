...
def main():
	...
	with open(dofile, "w+") as f:
		...
		if vhdl:
			...
			f.write(" -vhdl -Golden -continuousassignment Bidirectional -norangeconstraint -nooptimize\n")
		...
		if vlog:
			...
			# TODO see what these options do
			f.write(" -Verilog -Golden -continuousassignment Bidirectional -norangeconstraint -nooptimize\n")
