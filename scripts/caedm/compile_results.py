...
class Benchmark:
    ...
    def toString(self):
        return (
            self.name
            + "\t"
            + str(self.unreachableGolden)
            + "\t"
            + str(self.unreachableRevised)
            + "\t"
            + str(self.unmappedGolden)
            + "\t"
            + str(self.unmappedRevised)
            + "\t"
            + str(self.equivalencies)
            + "\t"
            + str(self.nonEquivalencies)
        )
...
def main():
    ...
    with open("results", "w+") as f:
        ...
        f.write(
            "design:\tunreachable golden:\tunreachable revised:\tunmapped golden:\tunmapped revised:\tequivalencies:\tnon-equivalencies:\n"
        )
