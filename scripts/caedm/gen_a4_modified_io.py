...
def main():
    ...
    # build file name
    dofile = join(pathToDesign, "modified_io.do")
    ...
    with open(dofile, "w+") as f:
        ...
        f.write(
            "read library -Both -Replace -sensitive -Verilog /auto/fsh/crg3710/research/lattice_libraries/sb_modified_io.v -nooptimize\n"
        )
        f.write(
