...
`ifdef XIL_XECLIB
  wire RST_A_async;
  wire RST_B_async;
  assign RST_A_async = (RST_MODE_A_BIN == RST_MODE_A_ASYNC) ? RST_A_in : 1'b0;
  assign RST_B_async = (RST_MODE_B_BIN == RST_MODE_B_ASYNC) ? RST_B_in : 1'b0;
`endif
...
`endif
  ...
  always @ (*) begin
    if (a_sleep || SLEEP_in || auto_sleep) begin
      ram_ce_a_int = 1'b0;
    end else if (EN_AUTO_SLEEP_MODE_BIN == EN_AUTO_SLEEP_MODE_FALSE) begin
      ram_ce_a_int = EN_A_int;
    end else begin
