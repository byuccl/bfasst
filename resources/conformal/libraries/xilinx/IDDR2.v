...
`endif // ONESPIN
    ...
    reg q0_out = INIT_Q0, q1_out = INIT_Q1;
    reg q0_out_int = INIT_Q0, q1_out_int = INIT_Q1;
    reg q0_c1_out_int = INIT_Q0, q1_c0_out_int = INIT_Q1;
...
`ifdef ONESPIN
   ...
   if (R == 1) begin
    ...
    end // always @ (posedge C0 or posedge R or posedge S)
   ...
   if (R == 1) begin
    ...
    end // always @ (posedge C1 or posedge R or posedge S)
  end
  endgenerate
`endif
