...
// `endif //  `ifndef XIL_TIMING
  ...
  assign RDADDRCHANGEB_BIN = 
   ...
   localparam rd_memp_loops_a = 
    ...
    (READ_WIDTH_A_REG == 36) ? 4 :
    (READ_WIDTH_A_REG == 72) ? 8 : 1;
   ...
   localparam rd_memp_loops_b = 
    ...
    (READ_WIDTH_B_REG == 18) ? 2 :
    (READ_WIDTH_B_REG == 36) ? 4 : 1;
...
// read engine
   ...
   memp_a_lat[0 +: rd_memp_loops_a] <= SRVAL_A_int[D_WIDTH +: rd_memp_loops_a];
      ...
      end // if (mem_rst_a && mem_rd_en_a)
   end // always @ (posedge mem_rd_clk_a)
...
// INIT/SRVAL values shouldn't cause error.
   ...
   always @ (posedge wrclk_ecc_out) begin
    if (ENBWREN_in)
