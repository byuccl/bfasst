...
// (above is true in 7SERIES - need to revisit for UltraScale)
  assign cout4     = s3[13];
...
// restored functionality
  assign COUT_out[3] =                                     cout_3;
  assign COUT_out[2] = (USE_SIMD_BIN == USE_SIMD_FOUR12) ? cout_2 : 1'b0;
  assign COUT_out[1] = (USE_SIMD_BIN != USE_SIMD_ONE48 ) ? cout_1 : 1'b0;
  assign COUT_out[0] = (USE_SIMD_BIN == USE_SIMD_FOUR12) ? cout_0 : 1'b0;
...
//    end
   ...
   assign PATTERN_DETECT_out   = opmode_valid_flag_dou ? pdet_o_mux  : 1'b0;
   assign PATTERN_B_DETECT_out = opmode_valid_flag_dou ? pdetb_o_mux : 1'b0;
